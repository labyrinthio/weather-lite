...
import 'clsx';
import { s as startTimer, p as parseCoords, g as getWeather, f as formatMin } from './metrics_CediK8nT.mjs';

const $$Min = createComponent(async ($$result, $$props, $$slots) => {
...
Usage: /weather/min?lat=48.14&lon=11.58`, {
      status: 400,
...
}, "/home/kenny/src/weather-lite/src/pages/weather/min.astro", void 0);

const $$file = "/home/kenny/src/weather-lite/src/pages/weather/min.astro";
const $$url = "/weather/min";
